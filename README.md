...
After the running VerTect, we will have the final viruses file *Final_continous_test_region.txt*, if the sample has some virus. The continuous distance mapping distance virus genome depends on user input lenght of reads. 
