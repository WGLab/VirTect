...
def main():
    ...
    def download_fasta():
        ...
        if (hg=="hg38"):
            ...
            os.system('''wget ftp://ftp.sanger.ac.uk/pub/gencode/Gencode_human/release_27/gencode.v27.chr_patch_hapl_scaff.annotation.gtf.gz -P human_reference''')
            
            print ("---------------------------------------- Unziping the gzip files -----------------------------------------------------")
